...
- `validarInsercao()`/`invalidarVeredito()` (T010, T041; testados em T014/T016) chegam por injeção da feature 014 (`FR-019`/`FR-021`, AD-109/AD-113) — mesmo padrão de `podeFinalizar()` já usado pela feature 004; a 014 não precisa estar implementada
