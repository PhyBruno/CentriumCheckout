...
- [ ] T019 [P] [US1] Implementar `src/client/features/cliente/CampoClienteVenda.tsx`: exibe `clienteAtual.nome`/`documento`, sem indicador de origem (`FR-006`, AD-053) — depende de T006 — **consultar o Pencil MCP antes de implementar** (CLAUDE.md § "Referência visual (design)")
