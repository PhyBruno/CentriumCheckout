...
**Decision**: A importação chama diretamente as actions de sobrescrita já expostas pelos slices de cliente (`trocarCliente`, feature 005) e vendedor (a definir pela feature 012, mesmo padrão), passando os dados do DAV — nunca um merge condicional com o default pré-selecionado.
