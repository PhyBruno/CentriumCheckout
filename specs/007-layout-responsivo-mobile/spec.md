...
- **FR-004**: No layout mobile, o sistema MUST permitir que o operador navegue de volta a qualquer etapa já visitada **enquanto a venda ainda admitir alteração de itens**, e MUST recusar a volta à etapa 1 (cliente e produtos) quando a venda já estiver em cobrança — condição de pagamento escolhida, desconto de capa aplicado ou forma de pagamento aprovada —, informando o mesmo motivo e a mesma saída que o carrinho já usa ("Limpar" no cartão de pagamento). Nenhum campo de cadastro incompleto (cliente, vendedor, condição) pode barrar o retorno, e a navegação entre as etapas 2 e 3 permanece livre. **Revisto em 2026-09-15 (AD-232):** a redação anterior dizia "navegue livremente ... a qualquer momento antes da finalização"; o usuário a revogou para a venda em cobrança, porque a etapa 1 inteira já era inerte nesse estado — inserir item ou editar produto lá é recusado pelo `carrinhoSlice` desde 2026-09-04, e o operador só descobria isso depois de chegar.
- **FR-005**: No layout mobile, os atalhos de **ação** do Checkout — o mapa fixo F1–F4/F10 e as teclas F6–F9 da venda rápida — MUST funcionar como no desktop, e a árvore mobile MUST NOT registrar atalho de teclado próprio. **Revisto em 2026-09-15 pela feature 016 (`FR-010`/`FR-011` daquela spec, AD-227):** a redação anterior mandava desativar no mobile todo atalho pensado para teclado físico; foi revogada para as teclas de ação porque um PDV de toque com teclado físico e sem mouse também precisa operar só pelo teclado. No compacto, F1/F2 recusam com explicação, porque a importação continua ausente dali (`FR-008`).
