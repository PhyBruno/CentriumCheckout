...
│   └── vendedor-domain-api.md   # superfície pública do slice + integração com carrinho (003/008), auditoria (001), DAV (006) e rascunho (011)
├── checklists/
