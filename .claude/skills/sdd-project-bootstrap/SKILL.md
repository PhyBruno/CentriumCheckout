...
2. **`rules.md`** — se não existir, cria a partir de `assets/rules.md.template` (regras de branch, commit+push obrigatório, gates). Se já existir, não mexe — o usuário pode ter regras específicas do projeto.
