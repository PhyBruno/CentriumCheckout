...
Modal PIX: frame `PDV Online Web - Modal PIX` (QR Code, copia e cola, badge de status). Tela principal e área "Pagamento e totais": ver `.specs/features/pagamento-geral/spec.md`. **Fonte do QR Code (2026-08-26, AD-079):** ver Edge Cases — o contrato atual de `GerarPIX` não devolve a imagem do QR Code, só o "copia e cola"; pendência de contrato aberta com o ERP.
