...
**Coverage:** 10 total, 0 edge cases bloqueantes, 0 pendências abertas (item 30 de `.specs/project/PENDENCIES.md` resolvido em 2026-08-26, AD-078 — campo `FormaIntegracaoCartao` confirmado na KB). `PAY-04` (status PIX) fica em `.specs/features/pagamento-pix/spec.md`.
