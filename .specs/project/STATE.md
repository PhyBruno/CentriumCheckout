...
- [ ] Confirmar com a equipe do ERP o contrato técnico completo do serviço de impressão local (porta, rota, formato de resposta) (2026-08-25, AD-037). **O indicativo de mecanismo de impressão no `GetSessao` já foi resolvido (2026-08-26, AD-082) — campo `TipoImpressao` (`'E'`/`'P'`).** Ver `.specs/features/finalizacao-suspensao-venda/spec.md`.
