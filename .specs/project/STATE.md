...
**Impact:** Fecha a sub-pendência `DavNum` do item 36 de `.specs/project/PENDENCIES.md` (as outras quatro seguem abertas) e **desbloqueia a feature 006**. Remove `davNum`/`DavNum` de `specs/006-importacao-dav/` (`data-model.md`, `contracts/erp-dav-api.md`, `contracts/importacao-domain-api.md`, `plan.md`). Reforça, sem alterar, AD-057 e AD-058.
