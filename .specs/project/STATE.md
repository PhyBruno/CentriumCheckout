...
**Pré-existente, fora do escopo desta feature:** 5 cenários E2E falham também sem estas mudanças (verificado com `git stash`) — 3 de `pagamento-geral.spec.ts` e 2 de `importacao-dav.spec.ts`, todos por SKUs (`070000`/`029000`/`001000`) que o `CATALOGO` do ERP mockado não tem.
